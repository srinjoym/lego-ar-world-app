...
class ChooseModelViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    
    private var tableView: UITableView!
    private var size: CGSize!
    weak var delegate: ChooseModelViewControllerDelegate?
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        delegate?.chooseModelViewController(self, object: Models[indexPath.row])
...
//
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let object = Models[indexPath.row]
        let thumbnailImage = UIImage(named: object.iconPath)!
...
// MARK: - ChooseModelViewControllerDelegate
protocol ChooseModelViewControllerDelegate: class {
